...
```{r eval metrics validation, echo=FALSE, fig.align='center', fig.retina=1}
...
```{r eval metrics testing, echo=FALSE, fig.align='center', fig.retina=1}
...
```{r best predictors, echo=FALSE, fig.align='center', fig.retina=1}
