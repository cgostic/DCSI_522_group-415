...
output: 
  html_document:
    toc: true
bibliography: ../docs/vanity_plates.bib
---
...
We recognize room for imporovement in our analysis, including testing other classification models, better visualizing the features identified as "best predictors" of rejection, and performing feature selection. In the future, we may also consider an advanced method of oversampling of the `rejected` class rather than undersampling the `accepted` class to correct the class imbalance.
